...
<td align="center"><a href="{pageContext.request.contextPath}/department_delete.action?did=<s:property value="#d.did"/>"><img src="{pageContext.request.contextPath}/images/edit.png"</a></td>
</tr>
</s:iterator>
...
<td align="right">
   ...
   <s:if test="currPage !=totalPage"> 
       ...
       <a href="{pageContext.request.contextPath}/department_findAll.action?currPage=<s:property value="totalPage"/>">[末页]</a>&nbsp;&nbsp;
   </s:if>      
   </span>
</td>
</tr>
